...
namespace Photon.Controllers
{
  ...
  public class ItemController(ItemService service) : ControllerBase
  {
    ...
    [HttpGet("items")]
    public async Task<IActionResult> GetAll([FromQuery] DateOnly? minExpirationDate,
      [FromQuery] DateOnly? maxExpirationDate, [FromQuery] string sortField = "Name",
      [FromQuery] bool ascendingSort = true)
    {

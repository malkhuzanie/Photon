...
namespace Photon.Services
{
  ...
  {
    public static async Task<MemoryStream> GeneratePdfReportItemsByFacility(string facilityName,
      IEnumerable<ItemReportDto> items)
    {
    ...
    public static async Task<MemoryStream> GeneratePdfReportUsersByFacility(string facilityName,
      IEnumerable<UserReportDto> users)
    {
      var pdfStream = new MemoryStream();
      QuestPDF.Settings.License = LicenseType.Community;
      await Task.Run(() =>

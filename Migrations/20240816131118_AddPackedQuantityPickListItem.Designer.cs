...
namespace Photon.Migrations
{
    ...
    [Migration("20240816131118_AddPackedQuantityPickListItem")]
    partial class AddPackedQuantityPickListItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Photon.Models.PickListItem", b =>
                {
                    ...
                    b.HasIndex("ItemPickupStatusId")
                        .HasDatabaseName("ix_pick_list_item_item_pickup_status_id");
            ...
            modelBuilder.Entity("Photon.Models.PickListItem", b =>
                {
                    ...
                    b.HasOne("Photon.Models.PurchaseOrder.ItemPickupStatus", "ItemPickupStatus")
                        ...
                        .HasConstraintName("fk_pick_list_item_item_pickup_status_item_pickup_status_id");

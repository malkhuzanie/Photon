...
namespace Photon.Migrations
{
    ...
    [Migration("20240730074129_RestructureIbPoItem")]
    partial class RestructureIbPoItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Photon.Models.PurchaseOrder.Inbound.InboundPurchaseOrderItem", b =>
                {
                    b.HasBaseType("Photon.Models.PurchaseOrder.PurchaseOrderItem");
            ...
            modelBuilder.Entity("Photon.Models.PurchaseOrder.Outbound.OutboundPurchaseOrderItem", b =>
                {
                    b.HasBaseType("Photon.Models.PurchaseOrder.PurchaseOrderItem");
            ...
            modelBuilder.Entity("Photon.Models.PurchaseOrder.PurchaseOrderItem", b =>
                {
                    b.HasOne("Photon.Models.Item", "Item")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_purchase_order_item_items_po_nbr");
            ...
            modelBuilder.Entity("Photon.Models.PurchaseOrder.Inbound.InboundPurchaseOrderItem", b =>
                {
                    b.HasOne("Photon.Models.PurchaseOrder.Inbound.InboundPurchaseOrder", "InboundPurchaseOrder")
                        .WithMany()
            ...
            modelBuilder.Entity("Photon.Models.PurchaseOrder.Outbound.OutboundPurchaseOrderItem", b =>
                {
                    b.HasOne("Photon.Models.PurchaseOrder.Outbound.OutboundPurchaseOrder", "OutboundPurchaseOrder")
                        .WithMany()

...
namespace Photon.Migrations
{
    ...
    [Migration("20240806192206_CreatePickList")]
    partial class CreatePickList
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Photon.Models.PickListItem", b =>
                {
                    ...
                    b.Property<int?>("PickListPlNbr")
                        .HasColumnType("integer")
                        .HasColumnName("pick_list_pl_nbr");
                    ...
                    b.HasIndex("PickListPlNbr")
                        .HasDatabaseName("ix_pick_list_item_pick_list_pl_nbr");
            ...
            modelBuilder.Entity("Photon.Models.PickListItem", b =>
                {
                    ...
                    b.HasOne("Photon.Models.PickList", null)
                        .WithMany("Items")
                        .HasForeignKey("PickListPlNbr")
                        .HasConstraintName("fk_pick_list_item_pick_lists_pick_list_pl_nbr");

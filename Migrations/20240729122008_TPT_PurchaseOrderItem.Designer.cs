...
namespace Photon.Migrations
{
    ...
    [Migration("20240729122008_TPT_PurchaseOrderItem")]
    partial class TPT_PurchaseOrderItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Photon.Models.InboundPurchaseOrderItem", b =>
                {
                    ...
                    b.HasIndex("PurchaseOrderPoNbr")
                        .HasDatabaseName("ix_inbound_purchase_order_details_purchase_order_po_nbr");

                    b.ToTable("inbound_purchase_order_details", (string)null);
                });
            ...
            modelBuilder.Entity("Photon.Models.OutboundPurchaseOrderItem", b =>
                {
                    ...
                    b.HasIndex("PurchaseOrderPoNbr")
                        .HasDatabaseName("ix_outbound_purchase_order_details_purchase_order_po_nbr");

                    b.ToTable("outbound_purchase_order_details", (string)null);
                });
            ...
            modelBuilder.Entity("Photon.Models.InboundPurchaseOrderItem", b =>
                {
                    b.HasOne("Photon.Models.PurchaseOrderItem", null)
                        .WithOne()
                        .HasForeignKey("Photon.Models.InboundPurchaseOrderItem", "PoNbr")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inbound_purchase_order_details_purchase_order_item_po_nbr");
                    ...
                    b.HasOne("Photon.Models.InboundPurchaseOrder", "PurchaseOrder")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inbound_purchase_order_details_inbound_purchase_orders_purc");
            ...
            modelBuilder.Entity("Photon.Models.OutboundPurchaseOrderItem", b =>
                {
                    b.HasOne("Photon.Models.PurchaseOrderItem", null)
                        .WithOne()
                        .HasForeignKey("Photon.Models.OutboundPurchaseOrderItem", "PoNbr")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outbound_purchase_order_details_purchase_order_item_po_nbr");
                    ...
                    b.HasOne("Photon.Models.OutboundPurchaseOrder", "PurchaseOrder")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outbound_purchase_order_details_outbound_purchase_orders_pu");

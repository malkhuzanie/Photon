...
namespace Photon.Migrations
{
    ...
    [Migration("20240729122434_TPT_PurchaseOrderItem_Fix")]
    partial class TPT_PurchaseOrderItem_Fix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Photon.Models.InboundPurchaseOrderItem", b =>
                {
                    ...
                    b.HasIndex("PurchaseOrderPoNbr")
                        .HasDatabaseName("ix_inbound_purchase_order_items_purchase_order_po_nbr");
            ...
            modelBuilder.Entity("Photon.Models.OutboundPurchaseOrderItem", b =>
                {
                    ...
                    b.HasIndex("PurchaseOrderPoNbr")
                        .HasDatabaseName("ix_outbound_purchase_order_items_purchase_order_po_nbr");
            ...
            modelBuilder.Entity("Photon.Models.InboundPurchaseOrderItem", b =>
                {
                    b.HasOne("Photon.Models.PurchaseOrderItem", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inbound_purchase_order_items_purchase_order_item_po_nbr");
                    ...
                    b.HasOne("Photon.Models.InboundPurchaseOrder", "PurchaseOrder")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inbound_purchase_order_items_inbound_purchase_orders_purcha");
            ...
            modelBuilder.Entity("Photon.Models.OutboundPurchaseOrderItem", b =>
                {
                    b.HasOne("Photon.Models.PurchaseOrderItem", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outbound_purchase_order_items_purchase_order_item_po_nbr");
                    ...
                    b.HasOne("Photon.Models.OutboundPurchaseOrder", "PurchaseOrder")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outbound_purchase_order_items_outbound_purchase_orders_purc");
